...
public class BrandShopDetailActivityAdapter<T> extends BaseAdapter {
	...
	public BrandShopDetailActivityAdapter(Context context,
			int[] textViewResourceId, List<T> objects, ListView listView) {
		super();
	...
	class ViewHolder {
		TextView name, text_detail_body, discount_time, zan_text, follow_text;
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			viewHolder.discount_time = (TextView) convertView
		...
		String timeString = com.yuyaa.awashcar.util.StringUtils
				.friendly_time(discount.getUpdated_at());
		if (timeString.equals("刚刚")) {
			viewHolder.discount_time.setTextColor(Color.argb(255, 255, 136, 0));
		} else {
			viewHolder.discount_time.setTextColor(Color
					.argb(255, 187, 187, 187));
		}
		viewHolder.discount_time.setText(timeString);
